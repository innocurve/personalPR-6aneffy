  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="w-full">
        <div className="mb-6 relative px-8 sm:px-12 md:px-16 py-3 sm:py-4 md:py-6 flex flex-col items-center">
          <svg className="absolute top-0 left-0 w-6 sm:w-8 md:w-12 h-6 sm:h-8 md:h-12 text-gray-300 transform -translate-x-1/3 -translate-y-1/3" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
          </svg>
          <h2 className="text-base sm:text-xl md:text-3xl relative z-10 text-center mb-3 sm:mb-4 md:mb-6 mx-8">
            {translate('valuesDescription', language).split('\n').map((line: string, i: number) => (
              <span key={i} className="block text-[10px] sm:text-sm md:text-2xl font-mono tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 whitespace-nowrap px-2">
                {line}
              </span>
            ))}
          </h2>
          <svg className="absolute bottom-0 right-0 w-6 sm:w-8 md:w-12 h-6 sm:h-8 md:h-12 text-gray-300 transform translate-x-1/3 translate-y-1/3 rotate-180" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
          </svg>
        </div>
